...
class Agent:
    ...
    def __init__(self, hyperparameter_set):
        ...
        # Path to Run info
        self.LOG_FILE   = os.path.join(RUN_DIRS, f"{self.hyperparameter_set}.log")
        self.MODEL_FILE = os.path.join(RUN_DIRS, f"{self.hyperparameter_set}.pt")
        self.GRAPH_FILE = os.path.join(RUN_DIRS, f"{self.hyperparameter_set}.png")
    ...
    def run(self, is_training=True, render=False):
        ...
        if is_training:
            ...
            # Keep track of the epsilon history
            epsilon_history = []
